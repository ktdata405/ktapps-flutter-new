...
class _MilkRecord {
  ...
  factory _MilkRecord.fromJson(Map<String, dynamic> j) {
    ...
    final unitPrice = double.tryParse('${j['unitprice'] ?? j['unitPrice'] ?? 80}') ?? 80;
    return _MilkRecord(
...
class _MilkReportScreenState extends State<MilkReportScreen> {
  ...
  double get _totalMorningLiters =>
      _allData.fold(0.0, (s, r) => s + r.morning);
  double get _totalEveningLiters =>
      _allData.fold(0.0, (s, r) => s + r.evening);
        ...
        children: [
          Container(
            ...
            decoration: BoxDecoration(
              ...
              boxShadow: [
                BoxShadow(
                    color: _primary.withValues(alpha: 0.35), blurRadius: 20)
              ],
            ),
          ...
          Expanded(
            child: Column(
              ...
              children: [
                const Text('Milk Report',
                    style: TextStyle(
                        color: _textWhite,
                        fontSize: 16,
                        fontWeight: FontWeight.w800)),
                Text('MONTHLY COLLECTION RECORDS',
                    style: TextStyle(
          ...
          _headerBtn(Icons.tune,
              onTap: () => setState(() => _filterExpanded = !_filterExpanded),
              active: _filterExpanded),
          const SizedBox(width: 6),
          _headerBtn(Icons.add, onTap: () => Navigator.push(context,
              MaterialPageRoute(builder: (_) => const MilkScreen()))),
          const SizedBox(width: 6),
  ...
  Widget _headerBtn(IconData icon,
    ...
    return GestureDetector(
      ...
      child: Container(
        ...
        child: Icon(icon,
            color: active ? _primary : const Color(0xFFB8C4EA), size: 16),
      ),
    );
  }
  ...
  Widget _heroChip(IconData icon, String label) {
    return Container(
      ...
      decoration: BoxDecoration(
        ...
        border: Border.all(color: const Color(0xFFBAC7FF).withValues(alpha: 0.28)),
              ...
              Row(
                children: [
                  Icon(Icons.filter_alt,
                      color: _primary.withValues(alpha: 0.7), size: 14),
                  const SizedBox(width: 8),
  ...
  Widget _quickFilterChip(String label, VoidCallback onTap) {
    return GestureDetector(
      ...
      child: Container(
        ...
        decoration: BoxDecoration(
          borderRadius: BorderRadius.circular(999),
          border: Border.all(color: const Color(0xFFBAC7FF).withValues(alpha: 0.34)),
  ...
  Widget _summaryViewToggle() {
    return Container(
      ...
      decoration: BoxDecoration(
        borderRadius: BorderRadius.circular(12),
        border: Border.all(color: const Color(0xFFBAC7FF).withValues(alpha: 0.26)),
        color: const Color(0xFF9AA8FF).withValues(alpha: 0.08),
      ),
      child: Row(
        children: [
          _viewToggleBtn('Card', Icons.grid_view, _summaryViewMode == 'card',
              () => setState(() => _summaryViewMode = 'card')),
          _viewToggleBtn('List', Icons.list, _summaryViewMode == 'list',
  ...
  Widget _summaryCard(String label, String value, String? subValue,
      Color labelColor, Color valueColor, Gradient bg) {
    return Container(
      padding: const EdgeInsets.all(12),
      decoration: BoxDecoration(
        gradient: bg,
  ...
  Widget _combinedStatsCard() {
    return Container(
      ...
      child: Column(
        children: [
          _statsLine('Morning Quantity', '${_totalMorningLiters.toStringAsFixed(1)} L',
              const Color(0xFFFCD34D), const Color(0xFFFBBF24)),
          const SizedBox(height: 8),
          _statsLine('Morning Amount', '₹${_formatNumber(_totalMorningAmount)}',
              const Color(0xFFFDE68A), const Color(0xFFFCD34D)),
          const SizedBox(height: 8),
          _statsLine('Evening Quantity', '${_totalEveningLiters.toStringAsFixed(1)} L',
              const Color(0xFFA5B4FC), const Color(0xFF818CF8)),
          const SizedBox(height: 8),
          _statsLine('Evening Amount', '₹${_formatNumber(_totalEveningAmount)}',
              const Color(0xFFBFDBFE), const Color(0xFFA5B4FC)),
        ],
      ),
    );
  }

  Widget _statsLine(String label, String value, Color labelColor, Color valueColor) {
    return Container(
      padding: const EdgeInsets.only(bottom: 4),
      decoration: BoxDecoration(
        border: Border(
          bottom: BorderSide(color: const Color(0xFFBAC7FF).withValues(alpha: 0.26)),
        ),
      ),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
  ...
  Widget _totalStatsCard() {
    return Container(
      ...
      child: Column(
        children: [
          _totalStatsLine('Total Quantity', '${_totalLiters.toStringAsFixed(1)} L',
              const Color(0xFF7DD3FC), const Color(0xFF22D3EE)),
          const SizedBox(height: 8),
          _totalStatsLine('Total Amount', '₹${_formatNumber(_totalCost)}',
              const Color(0xFFFCD34D), const Color(0xFF34D399)),
          const SizedBox(height: 8),
          _paymentStatusWidget(),
        ],
      ),
  ...
  Widget _totalStatsLine(String label, String value, Color labelColor, Color valueColor) {
    return Container(
      padding: const EdgeInsets.only(bottom: 4),
      decoration: BoxDecoration(
        border: Border(
          bottom: BorderSide(color: const Color(0xFF6EE7B7).withValues(alpha: 0.28)),
        ),
      ),
      child: Row(
        mainAxisAlignment: MainAxisAlignment.spaceBetween,
            ...
            : GestureDetector(
                ...
                child: Container(
                  ...
                  decoration: BoxDecoration(
                    ...
                    boxShadow: [
                      BoxShadow(
                          color: _rose.withValues(alpha: 0.35), blurRadius: 16)
                    ],
                  ),
                  child: const Row(
                    children: [
                      Icon(Icons.check_circle, color: Color(0xFFFECACA), size: 14),
                      SizedBox(width: 6),
                      Text('Un-Paid',
                          style: TextStyle(
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 8),
              const Text('DETAILED COLLECTION',
                  style: TextStyle(
                      color: Color(0xFFC7D2FE),
                      fontSize: 10,
                      fontWeight: FontWeight.w700,
              ...
              Container(
                ...
                child: Text('${_allData.length} days',
                    style: const TextStyle(
                        color: Color(0xFFD3DBFF),
                        fontSize: 9,
                        fontWeight: FontWeight.w700)),
  ...
  Widget _detailViewToggle() {
    return Container(
      ...
      child: Row(
        children: [
          _viewToggleBtn('Cards', Icons.grid_view, _viewMode == 'cards',
              () => setState(() => _viewMode = 'cards')),
          _viewToggleBtn('List', Icons.table_chart, _viewMode == 'list',
  ...
  Widget _dayCard(_MilkRecord record, int index, String theme) {
    ...
    final dateColor = isIndigo ? const Color(0xFFA5B4FC) : const Color(0xFF6EE7B7);
    ...
    return Container(
      ...
      decoration: BoxDecoration(
        gradient: LinearGradient(
          ...
          colors: isIndigo
              ? [const Color(0xFF353D66).withValues(alpha: 0.88), const Color(0xFF182039).withValues(alpha: 0.9)]
              : [const Color(0xFF174C56).withValues(alpha: 0.82), const Color(0xFF182039).withValues(alpha: 0.9)],
        ),
        ...
        children: [
          Row(
            children: [
              ...
              const SizedBox(width: 6),
              Text(_formatDateDisplay(record.date),
                  style: TextStyle(
                      color: dateColor,
                      fontSize: 12,
                      fontWeight: FontWeight.w800,
              ...
              Container(
                ...
                child: Text('₹${record.dailyCost.toStringAsFixed(2)}',
                    style: const TextStyle(
              ...
              GestureDetector(
                ...
                child: Container(
                  ...
                  child: const Icon(Icons.edit, color: Color(0xFFC7D2FE), size: 14),
                ),
              ),
            ],
          ),
          if (record.remarks.isNotEmpty) ...[
            ...
            Container(
              ...
              decoration: BoxDecoration(
                borderRadius: BorderRadius.circular(10),
                border: Border.all(color: const Color(0xFFBAC7FF).withValues(alpha: 0.14)),
                color: const Color(0xFF0C1222).withValues(alpha: 0.36),
              ),
              child: Text('📝 ${record.remarks}',
                  style: const TextStyle(
                      color: Color(0xFFBDC9EE), fontSize: 10)),
            ),
          ],
          const SizedBox(height: 9),
          Row(
            children: [
              Expanded(child: _blockItem('☀️ Morn', '${record.morning.toStringAsFixed(1)}', 'litres',
                  const Color(0xFFFBBF24), const Color(0xFFFCD34D))),
              const SizedBox(width: 8),
              Expanded(child: _blockItem('🌙 Eve', '${record.evening.toStringAsFixed(1)}', 'litres',
                  const Color(0xFF818CF8), const Color(0xFFA5B4FC))),
              const SizedBox(width: 8),
              Expanded(child: _blockItem('⚡ Total', '${record.total.toStringAsFixed(1)}', 'litres',
  ...
  Widget _blockItem(String label, String value, String sub, Color labelColor, Color valueColor) {
    return Container(
            ...
            child: const Row(
              children: [
                Expanded(flex: 2, child: Text('DATE', textAlign: TextAlign.center,
                    style: TextStyle(color: Color(0xFFA8B5DF), fontSize: 11, fontWeight: FontWeight.w700, letterSpacing: 0.8))),
                Expanded(child: Text('☀️', textAlign: TextAlign.center,
                    style: TextStyle(color: Color(0xFFFCD34D), fontSize: 11, fontWeight: FontWeight.w700))),
                Expanded(child: Text('🌙', textAlign: TextAlign.center,
                    style: TextStyle(color: Color(0xFFA5B4FC), fontSize: 11, fontWeight: FontWeight.w700))),
                Expanded(child: Text('⚡', textAlign: TextAlign.center,
                    style: TextStyle(color: Color(0xFF6EE7B7), fontSize: 11, fontWeight: FontWeight.w700))),
                Expanded(flex: 2, child: Text('₹ COST', textAlign: TextAlign.center,
          ...
          ...List.generate(_allData.length, (index) {
            ...
            return Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border(
                  top: BorderSide(color: const Color(0xFFBAC7FF).withValues(alpha: 0.08)),
                ),
              ),
              child: Row(
                children: [
                  Expanded(flex: 2, child: Text(_formatDateDisplay(r.date),
                      textAlign: TextAlign.center,
                      style: const TextStyle(color: Color(0xFFCBD5E1), fontSize: 12, fontFamily: 'monospace'))),
                  Expanded(child: Text('${r.morning.toStringAsFixed(1)} L',
                      textAlign: TextAlign.center,
                      style: const TextStyle(color: Color(0xFFFCD34D), fontSize: 12, fontWeight: FontWeight.w700))),
                  Expanded(child: Text('${r.evening.toStringAsFixed(1)} L',
                      textAlign: TextAlign.center,
                      style: const TextStyle(color: Color(0xFFA5B4FC), fontSize: 12, fontWeight: FontWeight.w700))),
                  Expanded(child: Text('${r.total.toStringAsFixed(1)} L',
                      textAlign: TextAlign.center,
                      style: const TextStyle(color: Color(0xFF6EE7B7), fontSize: 12, fontWeight: FontWeight.w800))),
                  Expanded(flex: 2, child: Text('₹${r.dailyCost.toStringAsFixed(2)}',
                      textAlign: TextAlign.center,
                      style: const TextStyle(color: Color(0xFFFBBF24), fontSize: 12, fontWeight: FontWeight.w800, fontFamily: 'monospace'))),
  ...
  Widget _emptyState() {
    return Container(
      ...
      child: Column(
        children: [
          Icon(Icons.inbox, color: const Color(0xFF9AA8FF).withValues(alpha: 0.4), size: 48),
          const SizedBox(height: 12),
                ...
                children: [
                  Container(
                    decoration: BoxDecoration(
                      shape: BoxShape.circle,
                      border: Border.all(
                          color: _primary.withValues(alpha: 0.2), width: 4),
                    ),
                  ),
                  const SizedBox(
                    width: 56,
                ...
                children: [
                  ...
                  if (isSettleDrafts) ...[
                    const Text(
                      ...
                      textAlign: TextAlign.center,
                      style: TextStyle(color: _textGray400, fontSize: 13, height: 1.6),
                    ),
                    const SizedBox(height: 12),
                    Container(
                      ...
                      Expanded(
                        child: GestureDetector(
                          ...
                          child: Container(
                            ...
                            child: Text(
                              isSettleDrafts ? 'Review Draft Days' : 'Cancel',
                              textAlign: TextAlign.center,
                              style: const TextStyle(
                                  color: _textGray400,
                                  fontSize: 13,
                          ...
                          child: Container(
                            ...
                            child: Row(
                              ...
                              children: [
                                ...
                                const SizedBox(width: 6),
                                Text(
                                  isSettleDrafts ? 'Settle Drafts' : 'Mark Paid',
                                  style: const TextStyle(
                                      color: Colors.white,
                                      fontSize: 13,
                                      fontWeight: FontWeight.w800),
